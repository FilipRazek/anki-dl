    ...
    fn test_get_body_compression() {
        assert_eq!(
            ...
            [
                ...
                112, 97, 115, 115, 119, 111, 114, 100, 34, 125
            ]
        );
        assert_eq!(
            build(UserCredentials {
            ...
            [
                ...
                112, 64, 114, 97, 122, 101, 107, 46, 111, 114, 103, 34, 44, 34, 112, 34, 58, 34,
                99, 48, 77, 112, 108, 49, 99, 52, 116, 51, 68, 95, 80, 97, 36, 36, 119, 48, 82,
                100, 34, 125
            ]
        );
        assert_eq!(
            ...
            [
                ...
                112, 64, 114, 97, 122, 101, 107, 46, 111, 114, 103, 34, 44, 34, 112, 34, 58, 34,
                108, 101, 116, 109, 101, 105, 110, 49, 50, 51, 34, 125
            ]
        );
        assert_eq!(
            build(UserCredentials {
                user: String::from("test@gmail.com"),
                password: String::from("letmein123"),
            })
            .unwrap(),
            [
                40, 181, 47, 253, 0, 88, 57, 1, 0, 123, 34, 117, 34, 58, 34, 116, 101, 115, 116,
                64, 103, 109, 97, 105, 108, 46, 99, 111, 109, 34, 44, 34, 112, 34, 58, 34, 108,
                101, 116, 109, 101, 105, 110, 49, 50, 51, 34, 125
            ]
        );
    }
}
